object frmChargeUsedbyReserveRpt: TfrmChargeUsedbyReserveRpt
  Left = 71
  Top = 6
  HelpContext = 301
  BiDiMode = bdRightToLeft
  BorderStyle = bsDialog
  Caption = #1711#1586#1575#1585#1588' '#1575#1593#1578#1576#1575#1585' '#1605#1589#1585#1601' '#1588#1583#1607' '#1575#1586' '#1591#1585#1610#1602' '#1576#1585#1606#1575#1605#1607' '#1585#1610#1586#1610' '#1594#1584#1575#1610#1610' '#1662#1585#1587#1606#1604' - '#1585#1586#1585#1608
  ClientHeight = 388
  ClientWidth = 464
  Color = clBtnFace
  ...
  object grpDate: TGroupBox
    ...
    Width = 265
    Height = 82
    Caption = #1601#1610#1604#1578#1585' '#1578#1575#1585#1610#1582
    TabOrder = 8
  ...
  object rdoGroupsKind: TRadioGroup
    Left = 8
    Top = 151
    Width = 178
    Height = 83
