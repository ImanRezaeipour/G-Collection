    ...
    public class logRepository
    {
        ...
        public bool InsertToLogTable(Model.Log logObj)
        {
            ...
            catch (Exception ex)
            {
                ...
                //LogObj.LayerName = Log.LayerNameEnum.Repository.ToString();
                //LogObj.MethodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
                //LogObj.Comment = string.Format("خطا در ثبت در جدول لاگ {0}، متن پیغام {1}.خطا","", Utility.Utility.GetExecptionMessage(ex));
                //bool BoolResult = new logRepository().InsertToLogTable(LogObj);
            ...
            try
            {
                ...
                switch (searchField)
                {
                    ...
                    case LogSearchFields.UserName:
                        ...
                        break;
                    case LogSearchFields.PersonPost:
                        commandText += " AND PersonPost = @PersonPost";
                        SqlParameter personpost = new SqlParameter("@PersonPost", searchKey);
                        paramArray.Add(personpost);
                        break;
