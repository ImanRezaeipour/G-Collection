object frmRptPeymanUnit: TfrmRptPeymanUnit
  Left = -4
  Top = -4
  BiDiMode = bdLeftToRight
  Caption = #1711#1586#1575#1585#1588' '#1570#1605#1575#1585' '#1594#1584#1575#1610#1610' '#1608#1575#1581#1583#1607#1575#1610' '#1578#1575#1576#1593#1607
  ClientHeight = 712
  ClientWidth = 1024
  Color = clBtnFace
  ...
  object qrptPeyman: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = #1711#1586#1575#1585#1588' '#1570#1605#1575#1585' '#1594#1584#1575#1610#1610' '#1608#1575#1581#1583#1607#1575#1610' '#1578#1575#1576#1593#1607
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object grpUnits: TQRGroup
      ...
      Frame.DrawRight = True
      AlignToBottom = False
      BeforePrint = grpUnitsBeforePrint
      Color = clWhite
      TransparentBand = False
      ForceNewColumn = False
      ForceNewPage = True
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'qryFishFood.Fish_UCode'
      FooterBand = bndAll
      Master = qrptPeyman
  ...
  object qryFishFood: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT FishFood.*, Fish_UCode, Food_Name, Unit_Name FROM FishFoo' +
        'd, Fish, FoodList, Units'
      ...
      'AND Fish_UCode > 0'
      'ORDER BY Fish_UCode, FF_Food, FF_Pay')
    Left = 24
    Top = 8
  end
end
