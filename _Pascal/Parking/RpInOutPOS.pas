...
procedure TfrmRptInOutPOS.SetWinF;
begin
  Caption := (Caption);
...
procedure TfrmRptInOutPOS.FormCreate(Sender: TObject);
begin
  SetWinF;
...
procedure TfrmRptInOutPOS.qryMachinesCalcFields(DataSet: TDataSet);
begin
  with DataSet do
  begin
