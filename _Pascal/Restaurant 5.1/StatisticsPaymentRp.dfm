object frmStatisticsPaymentRpt: TfrmStatisticsPaymentRpt
  Left = 124
  Top = 102
  HelpContext = 306
  BiDiMode = bdRightToLeft
  BorderStyle = bsDialog
  Caption = #1711#1586#1575#1585#1588' '#1570#1605#1575#1585' '#1585#1610#1575#1604#1610' '#1585#1587#1578#1608#1585#1575#1606#1607#1575
  ClientHeight = 201
  ClientWidth = 319
  Color = clBtnFace
