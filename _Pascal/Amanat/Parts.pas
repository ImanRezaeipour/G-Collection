...
begin
  ...
  txtName.Text := '';
  txtDay.Text := '1'; //kaveh
  chkDelRemain.Checked := False; //kaveh
  txtName.SetFocus;
end;
...
begin
  ...
  begin
    ...
    txtDay.Text := IntToStr(adotblParts.FieldByName('Part_Day').AsInteger); //kaveh
    chkDelRemain.Checked := adotblParts.FieldByName('Part_DelRemain').AsBoolean; //kaveh
...
procedure TfrmParts.txtDayExit(Sender: TObject);
begin
  if txtDay.Text = '' then
    txtDay.Text := '1';
...
procedure TfrmParts.txtDayKeyPress(Sender: TObject; var Key: Char);
begin
  Keyboard_Integer(Key);
end;
...
begin
  ...
  begin
    ...
    adotblParts.FieldByName('Part_Day').AsInteger := StrToInt(txtDay.Text); //kaveh
    adotblParts.FieldByName('Part_DelRemain').AsBoolean := chkDelRemain.Checked; //kaveh
