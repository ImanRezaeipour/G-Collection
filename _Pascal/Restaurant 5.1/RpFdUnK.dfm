object frmRptUnitFoodK: TfrmRptUnitFoodK
  Left = -4
  Top = -4
  BiDiMode = bdLeftToRight
  Caption = #1711#1586#1575#1585#1588' '#1603#1604#1610' '#1605#1608#1575#1583' '#1594#1584#1575#1610#1610' '#1608#1575#1581#1583#1607#1575#1610' '#1578#1575#1576#1593#1607
  ClientHeight = 712
  ClientWidth = 1024
  Color = clBtnFace
  ...
  object qrptUnitFood: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = #1711#1586#1575#1585#1588' '#1603#1604#1610' '#1605#1608#1575#1583' '#1594#1584#1575#1610#1610' '#1608#1575#1581#1583#1607#1575#1610' '#1578#1575#1576#1593#1607
    SnapToGrid = True
    Units = MM
    Zoom = 100
  ...
  object qryUnitFood: TADOQuery
    Parameters = <>
    SQL.Strings = (
      'SELECT Fish_UCode, Fish_Date, Fish_Type, Fish_UPrc, Fish_UPay,'
      ...
      'ORDER BY Fish_UCode, Fish_Date, Fish_Type')
    Left = 35
    Top = 8
  end
end
