object frmRptListFish: TfrmRptListFish
  Left = -4
  Top = -4
  ...
  object qrptFish: TQuickRep
    ...
    BeforePrint = qrptFishBeforePrint
    DataSet = qryFish
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    ...
    PrintIfEmpty = True
    ReportTitle = #1711#1586#1575#1585#1588' '#1604#1610#1587#1578' '#1601#1610#1588#1607#1575#1610' '#1575#1601#1585#1575#1583
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object QRBand2: TQRBand
      ...
      object QRLabel20: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = #1594#1584#1575#1607#1575#1610' '#1605#1589#1585#1601#1610
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
    ...
    object qrpDateType: TQRGroup
      ...
      Frame.DrawRight = True
      AlignToBottom = False
      BeforePrint = qrpDateTypeBeforePrint
      Color = clWhite
      TransparentBand = False
      ForceNewColumn = False
      ForceNewPage = False
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'qryFish.Fish_Date  + STR(qryFish.Fish_Type)'
      FooterBand = bndDate
      Master = qrptFish
    ...
    object grpPartJob: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'qryFish.P_PartCode + qryFish.P_JobCode'
      Master = qrptFish
      ReprintOnNewPage = False
    ...
    object DetailBand2: TQRBand
      ...
      object QRExpr2: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'qryFish.P_Family + IF(qryFish.P_Name <> '#39#39','#39' - '#39','#39#39') + qryFish.P' +
          '_Name'
        FontSize = 10
      end
    ...
    object bndDate: TQRBand
      ...
      object lblFishCount: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = ':'#1578#1593#1583#1575#1583' '#1601#1610#1588#1607#1575
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
  ...
  object qryFish: TADOQuery
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM Fish, Persons'
      'WHERE Fish_PCode = P_BarCode'
      'ORDER BY Fish_Date, Fish_Type')
    Left = 12
    Top = 8
  end
  object qryFishFood: TADOQuery
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM FishFood'
      'WHERE FF_FishNo = :FishNo'
      'AND FF_Type = :FishType'
      'AND FF_Date = :FishDate')
    Left = 116
    Top = 8
  end
end
