<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.Master" AutoEventWireup="true" CodeBehind="AdminContentPage.aspx.cs" Inherits="WebRest.Admin.AdminContentPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../Scripts/AdminContentPage_onOperations.js" type="text/javascript"></script>
</asp:Content>
    ...
    <dx:ASPxNavBar ID="ASPxNavBarMain_ContentPage" ClientInstanceName="NavBarMain_ContentPage" runat="server" CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css"
        ...
        <Groups>
            <dx:NavBarGroup Name="OperationsGroup"  Text="عملیات" Visible="true">
                <Items>
                    <dx:NavBarItem Text="معرفی کاربران" Name="/Admin/AdminDefineUsers.aspx" Visible="true">
                    </dx:NavBarItem>
                     <dx:NavBarItem Text="تعریف کاربران پیشفرض" Name="/Admin/AdminDefineDefaultUser.aspx" Visible="true">
                    </dx:NavBarItem>
                        <dx:NavBarItem Text="تنظیمات" Name="/Admin/AdminSettings.aspx" Visible="true">
                    </dx:NavBarItem>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageControlContent" runat="server">
    <dx:ASPxPageControl ID="ASPxPageControlContent_ContentPage" runat="server"
        ActiveTabIndex="0" ClientInstanceName="PageControlContent_ContentPage" 
        ...
        <TabPages>
            <dx:TabPage   Name="/Admin/AdminDefineUsers.aspx" Text="معرفی کاربران"
                ClientVisible="False" ActiveTabStyle-VerticalAlign="NotSet">
                <ContentCollection>
                    <dx:ContentControl ID="AdminDefineUsers" runat="server" SupportsDisabledAttribute="True">
                        <!--iframe will be inserted here-->
                    </dx:ContentControl>
                </ContentCollection>
            </dx:TabPage>
            <dx:TabPage   Name="/Admin/AdminDefineDefaultUser.aspx" Text="تعریف کاربران پبشفرض"
                ClientVisible="False" ActiveTabStyle-VerticalAlign="NotSet">
                <ContentCollection>
            ...
            <dx:TabPage   Name="/Admin/AdminSettings.aspx" Text="تنظیمات"
                ClientVisible="False" ActiveTabStyle-VerticalAlign="NotSet">
                <ContentCollection>
