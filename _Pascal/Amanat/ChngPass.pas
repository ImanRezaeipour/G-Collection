...
begin
  ...
  begin
    ...
    begin
      ...
      if txtBeforePassword.Text<>decodingpass(FieldByName('User_Password').AsString) then
      begin
        ErrorMessage('ﬂ·„Â ⁄»Ê— ﬂ«—»— «‘ »«Â «” .');
        txtBeforePassword.SetFocus;
      end
      else if txtNewPassword.Text <> txtRepeatPassword.Text then
      begin
      ...
      begin
        Edit;
        FieldByName('User_Password').AsString := codingpass(txtNewPassword.Text);
        Post;
