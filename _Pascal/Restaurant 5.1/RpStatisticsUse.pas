...
type
  TfrmRptStatisticsUse = class(TForm)
...
{$R *.DFM}
procedure TfrmRptStatisticsUse.SetWinF;
begin
  Caption := (Caption);
...
procedure TfrmRptStatisticsUse.FormCreate(Sender: TObject);
begin
  SetWinF;
//  grpFood.Height := 0;
//  dtlRecs.Height := 0;
...
procedure TfrmRptStatisticsUse.FoodBndBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  FCode : Integer;
  p : Currency;
...
procedure TfrmRptStatisticsUse.bndAllAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
{
  AllPayNo := 0;
...
procedure TfrmRptStatisticsUse.dtlRecsBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
{
...
procedure TfrmRptStatisticsUse.grpFoodBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
{
  PayNo := 0;
...
procedure TfrmRptStatisticsUse.bndAllBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
{
...
procedure TfrmRptStatisticsUse.qrptPeymanBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
