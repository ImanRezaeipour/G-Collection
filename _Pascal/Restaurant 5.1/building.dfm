object frmBuilding: TfrmBuilding
  ...
  Caption = #1605#1593#1585#1601#1610' '#1587#1575#1582#1578#1605#1575#1606#1607#1575' '
  ClientHeight = 246
  ClientWidth = 464
  Color = clBtnFace
  ...
  object grpAll: TGroupBox
    ...
    Align = alTop
    TabOrder = 0
    object dbgBuilding: TDBGrid
      Left = 112
      Top = 16
      Width = 345
      Height = 157
      DataSource = dtaBuilding
  ...
  object grpEdit: TGroupBox
    ...
    object lbl1: TLabel
      ...
      Width = 48
      Height = 15
      Caption = #1705#1583' '#1587#1575#1582#1578#1605#1575#1606
  ...
  object dtaBuilding: TDataSource
    DataSet = tblBuilding
    Left = 304
    Top = 72
  end
  object tblBuilding: TADOTable
    ...
    Left = 248
    Top = 72
    object tblBuildingBuilding_Code: TSmallintField
      Alignment = taCenter
      DisplayLabel = #1705#1583' '
      DisplayWidth = 13
      FieldName = 'Building_Code'
    end
    object tblBuildingBuilding_Name: TStringField
