object frmRptPrsFoodM: TfrmRptPrsFoodM
  Left = -4
  Top = -4
  ...
  object qrptPrsFood: TQuickRep
    ...
    object grpPartJob: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'STR(qryPrsFood.P_PartCode) + STR(qryPrsFood.P_JobCode)'
      FooterBand = bndGrpPartJob
      Master = qrptPrsFood
    ...
    object bndGrpDate: TQRBand
      ...
      Frame.DrawRight = True
      AlignToBottom = False
      BeforePrint = bndGrpDateBeforePrint
      Color = clWhite
      TransparentBand = False
      ForceNewColumn = False
      ForceNewPage = False
    ...
    object grpDateBarCode: TQRGroup
      Left = 38
      Top = 177
      Width = 718
      Height = 24
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'qryPrsFood.P_BarCode+COPY(qryPrsFood.Fish_Date,6,2)'
      FooterBand = bndGrpDate
      Master = qrptPrsFood
      ReprintOnNewPage = False
    end
    object bndGrpPartJob: TQRBand
      Left = 38
      Top = 249
      Width = 718
      Height = 32
      ...
      Frame.DrawLeft = True
      Frame.DrawRight = True
      AfterPrint = bndGrpPartJobAfterPrint
      AlignToBottom = False
      BeforePrint = bndGrpPartJobBeforePrint
      Color = clWhite
      TransparentBand = False
      ForceNewColumn = False
      ForceNewPage = False
  ...
  object qryPrsFood: TADOQuery
    ...
    SQL.Strings = (
      ...
      'ORDER BY P_PartCode, P_JobCode, P_BarCode, Fish_Date')
    Left = 15
    Top = 8
  end
