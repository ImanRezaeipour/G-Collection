    ...
    public partial class DevMonthlyReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                FillPishCard(personObj.Barcode, "isDaily='False'");
            }
        ...
        private void FillUnderManagmentPersonnel(decimal webPassID)
        {
            try
            {
                ...
                int rowSelected = ((DevExpress.Web.ASPxGridView.ASPxGridView)ASPxDropDownEdit2.FindControl("ASPxGridView5")).FindVisibleIndexByKeyValue(((Person)Session["PersonObj"]).Barcode);
        ...
        protected void ASPxGridView2_HtmlRowPrepared(object sender, ASPxGridViewTableRowEventArgs e)
        {
            ...
            {
                ((ASPxGridView)sender).JSProperties.Add("cpError", "خطا در تعیین رنگ وضعیت درخواست ها " + ex.Message);
            }
        ...
        protected void ASPxGridView2_HtmlDataCellPrepared(object sender, ASPxGridViewTableDataCellEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                ((ASPxGridView)sender).JSProperties.Add("cpError","خطا در تعیین وضعیت درخواست ها "  + ex.Message);
            }
        ...
        protected void ASPxGridView2_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            try
            {
                ...
                string idRowSelected = e.Keys["ID_PK"].ToString();
                string RetMessage = new BRequest().DeleteRequestByID(idRowSelected);
        ...
        protected void ASPxGridView2_RowInserting(object sender, ASPxDataInsertingEventArgs e)
        {
            try
            {
                ...
                if (selectedType == "3" && resultAgreeOverTime == false)
                {
                    ...
                    throw new MyExceptionHandler("شما مجوز دسترسی به این قسمت را ندارید.");
                }
                ...
                if (pishcardSelected == "")
                    throw new MyExceptionHandler("پیش کارت مورد نظر را انتخاب نمایید.");
        ...
        protected void ASPxGridViewReportMonthly_htmldatacellprepared(object sender, ASPxGridViewTableDataCellEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                ((ASPxGridView)sender).JSProperties.Add("cpError", "خطا در تعیین  رنگ روزهای تردد." + ex.Message);
            }
