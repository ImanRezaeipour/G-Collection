...
{$R *.DFM}
procedure TfrmRptPeyman.SetWinF;
begin
  Caption := (Caption);
...
procedure TfrmRptPeyman.FormCreate(Sender: TObject);
begin
  SetWinF;
  grpFood.Height := 0;
  dtlRecs.Height := 0;
...
procedure TfrmRptPeyman.FoodBndBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  FCode : Integer;
  p : Currency;
...
procedure TfrmRptPeyman.bndAllAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  AllPayNo := 0;
  AllPriceNo := 0;
...
procedure TfrmRptPeyman.dtlRecsBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmRptPeyman.grpFoodBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  PayNo := 0;
  PriceNo := 0;
...
procedure TfrmRptPeyman.bndAllBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmRptPeyman.qrptPeymanBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
