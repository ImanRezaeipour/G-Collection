object frmEmployeeRpt: TfrmEmployeeRpt
  Left = 127
  Top = -6
  ...
  object cmbActive: TComboBox
    ...
    Items.Strings = (
      #1607#1605#1607' '#1575#1601#1585#1575#1583
      #1575#1601#1585#1575#1583' '#1601#1593#1575#1604
      #1575#1601#1585#1575#1583' '#1594#1610#1585#1601#1593#1575#1604)
  end
  ...
  object grdFields: TXStringGrid
    ...
    Columns = <
      ...
      item
        ...
        HeaderFont.Style = []
        HeaderAlignment = taCenter
        Caption = #1593#1585#1590' '#1601#1610#1604#1583'-'#1662#1610#1603#1587#1604
        Width = 95
        Font.Charset = ARABIC_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
