object frmEmploymentType: TfrmEmploymentType
  Left = 108
  Top = 53
  HelpContext = 102
  ...
  object grpAll: TGroupBox
    ...
    Align = alTop
    TabOrder = 0
    object dbgEmplType: TDBGrid
      Left = 112
      Top = 16
      Width = 345
      Height = 157
      DataSource = dtaEmplType
      ...
      OnKeyDown = dbgEmplTypeKeyDown
      Columns = <
        item
          Expanded = False
          FieldName = 'EmplType_Code'
  ...
  object dtaEmplType: TDataSource
    DataSet = adotblEmplType
    Left = 304
    Top = 72
  end
  object adotblEmplType: TADOTable
    TableName = 'EmplType'
    Left = 240
    Top = 72
  end
