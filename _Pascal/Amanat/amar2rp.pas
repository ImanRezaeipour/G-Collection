...
begin
  ...
  begin
    ...
    begin
      ...
      qry.SQL.Clear;
      qry.SQL.add('select grpdate as date1,grptime as time1,GrpPrice as mablagh1,Empl_Name,Empl_Family,Empl_No');
      qry.SQL.add('from ChargeGrp,ChargeDtl,employee');
      qry.SQL.add('where GrpCode=DtlCode');
      qry.SQL.add('and Empl_No=DtlEmplNo');
      if txtFromDate.Text<>''
      ...
      qry.SQL.add('order by grpdate,grptime,Empl_Family,Empl_Name');
      qry.open;
      begin
