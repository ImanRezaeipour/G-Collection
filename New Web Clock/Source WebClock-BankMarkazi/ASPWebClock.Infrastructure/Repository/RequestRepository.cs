...
namespace ASPWebClock.Infrastructure.Repository
{
    public class RequestRepository : RepositoryBase
    {
        ...
        private string GetPersonStatusFilter(Person prs,Person prsCurrentUser, bool UnderReview, bool Confirmed, bool Rejected)
        {
            try
            {
                ...
                if (Confirmed)
                {
                    ...
                    {
                        case PersonStatus.EarlyManagment:
                            //Result += "Clock_FirstlyAgree = 1 AND (Clock_FirstlyAgree_BarCode LIKE '%" + prs.BarCode + "%' OR Clock_FirstlyAgree_BarCode LIKE '%" + prsCurrentUser.BarCode + "%'))";
                            Result += "Clock_FirstlyAgree = 1 )";
                            break;
                        case PersonStatus.SecondManagment:
                            // Result += "Clock_SeconderyAgree = 1 AND (Clock_FirstlyAgree_BarCode LIKE '%" + prs.BarCode + "%' OR Clock_FirstlyAgree_BarCode LIKE '%" + prsCurrentUser.BarCode + "%'))";
                            Result += "Clock_SeconderyAgree = 1 )";
                            break;
                        case PersonStatus.FinalManagment:
                            //Result += "Clock_FinallyAgree = 1 AND Clock_FirstlyAgree_BarCode LIKE '%" + prs.BarCode + "%' OR Clock_FirstlyAgree_BarCode LIKE '%" + prsCurrentUser.BarCode + "%'))";
                ...
                if (Rejected)
                {
                    ...
                    {
                        case PersonStatus.EarlyManagment:
                            // Result += "Clock_FirstlyAgree = 2 AND Clock_FirstlyAgree_BarCode LIKE '%" + prs.BarCode + "%')";
                            Result += "Clock_FirstlyAgree = 2 )";
                            break;
                        case PersonStatus.SecondManagment:
                            // Result += "Clock_SeconderyAgree = 2 AND Clock_FirstlyAgree_BarCode LIKE '%" + prs.BarCode + "%')";
                            Result += "Clock_SeconderyAgree = 2 )";
                            break;
                        case PersonStatus.FinalManagment:
                            //Result += "Clock_FinallyAgree = 2 AND Clock_FirstlyAgree_BarCode LIKE '%" + prs.BarCode + "%')";
        ...
        public string DeleteRequestDialyByOperator(string barcode, string pishID, string date, string time, string reader,string tableName)
        {
        ...
        public string DeleteRequestHourlyTrafficByOperator(string barcode, string pishID, string date, string time, string reader, string tableName)
        {
        ...
        public string EditRequestHourlyPermitByOperator(string barcode, string pishID, string date, string comment, string Operator, int change, int Readers, int fromHour, int toHour, string tableName,string oldPishID,int oldFromTime,int oldToTime,string oldDate)
        {
        ...
        public string EditRequestHourlyTrafficByOperator(string barcode, string pishID, string date, string comment, string Operator, int change, int Readers, int time, string tableName, string oldPishID, int oldTimes, string oldDate)
        {
        ...
        public string DeleteRequestHourlyPermitByOperator(string barcode, string pishID, string date, string fromTime,string toTime, string tableName)
        {
        ...
        public string DeleteRequestByID(string id)
        {
            ...
            try
            {
                bool result = CheckAccessDeleteRequestByID(id);
                ...
                {
                    return "شما مجوز حذف این درخواست را ندارید";
                }
