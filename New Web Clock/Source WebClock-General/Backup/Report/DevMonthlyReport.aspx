...
<body>
    ...
    <table
                                    ...
                                    style="table-layout: fixed; display: block; height: 27px; font-family: tahoma; font-size: 9pt; width: 90%;" 
...
<Summary Text="صفحه {0} از {1}"></Summary>
    ...
    <tr>
     ...
     <td align="right" width="120">
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
            CssPostfix="Aqua" DataSourceID="SqlDataSource1" KeyFieldName="prc_date" 
               OnDetailRowGetButtonVisibility="ASPxGridView1_DetailRowGetButtonVisibility" OnHtmlRowPrepared="ASPxGridView1_HtmlRowPrepared"
            RightToLeft="True"
