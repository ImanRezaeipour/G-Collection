object frmPersonNoFishRpt: TfrmPersonNoFishRpt
  Left = 123
  Top = 75
  HelpContext = 310
  BiDiMode = bdRightToLeft
  BorderStyle = bsDialog
  Caption = #1604#1610#1587#1578' '#1662#1585#1587#1606#1604#1610' '#1603#1607' '#1594#1584#1575' '#1606#1582#1608#1585#1583#1607' '#1575#1606#1583
  ClientHeight = 349
  ClientWidth = 374
  Color = clBtnFace
