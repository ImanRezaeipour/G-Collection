    ...
    case cmbOperate.ItemIndex of
      ...
      begin
        ...
        for i := 2 to 6 do
          ...
          else if Readers[cmbReaders.ItemIndex+1].R_Type = RDR_CLK6000 then
            ST := ST + '????';
        OK := SetAccessCode(Readers[cmbReaders.ItemIndex+1], ST);
        Msg_NoWait;
        Mouse_NoWait;
        if OK then
      ...
      begin
        ...
        OK := GetAccessCode(Readers[cmbReaders.ItemIndex+1], ST);
        for i := 2 to 6 do
        begin
      ...
      begin
        ...
        OK := DelAccessCode(Readers[cmbReaders.ItemIndex+1]);
        Msg_NoWait;
        Mouse_NoWait;
        if OK then
