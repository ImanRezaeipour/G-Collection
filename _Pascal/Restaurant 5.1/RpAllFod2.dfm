object frmRptAllFood2: TfrmRptAllFood2
  Left = -4
  Top = -4
  ...
  object qrptAllFood2: TQuickRep
    ...
    BeforePrint = qrptAllFood2BeforePrint
    DataSet = qryAllFood
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    ...
    object grpDate: TQRGroup
      ...
      KeepOnOnePage = False
      Expression = 'qryAllFood.p_parts+qryAllFood.Fish_Date'
      FooterBand = bndDate
      Master = qrptAllFood2
    ...
    object bndGuestFooter: TQRBand
      ...
      object exprPay: TQRExpr
        ...
        AutoStretch = False
        Color = clWhite
        OnPrint = exprPayPrint
        ResetAfterPrint = True
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qryAllFood.FF_Pay)'
        FontSize = 10
      end
      object exprNotPay: TQRExpr
        Left = 156
        Top = 8
        Width = 162
        Height = 17
        ...
        AutoStretch = False
        Color = clWhite
        OnPrint = exprNotPayPrint
        ResetAfterPrint = True
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qryAllFood.FF_Price)'
        FontSize = 10
      end
      ...
      object exprAllPrc: TQRExpr
        ...
        AutoStretch = False
        Color = clWhite
        OnPrint = exprAllPrcPrint
        ResetAfterPrint = True
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qryAllFood.FF_Price  +  qryAllFood.FF_Pay)'
        FontSize = 10
      end
      object lblTotFish: TQRLabel
        Left = 503
        Top = 8
        Width = 58
        Height = 17
    ...
    object grpGuest: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'qryAllFood.P_IsGuest'
      FooterBand = bndGuestFooter
      Master = qrptAllFood2
      ReprintOnNewPage = False
    end
  ...
  object qryAllFood: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT P_BarCode, P_Rejim, P_IsGuest, Fish_Date, FF_Price, FF_Pa' +
        'y, FF_Type, FF_FishNo'
      ...
      'AND Fish_Date = '#39'1380/08/19'#39
      'ORDER BY Fish_Date, P_Rejim, P_IsGuest, FF_Type, FF_FishNo')
    Left = 12
    Top = 11
  end
end
