object frmGhFishRpt: TfrmGhFishRpt
  Left = 123
  Top = 75
  HelpContext = 311
  BiDiMode = bdRightToLeft
  BorderStyle = bsDialog
  Caption = #1604#1610#1587#1578' '#1688#1578#1608#1606' '#1576#1711#1610#1585#1575#1606' '#1576#1583#1608#1606' '#1581#1590#1608#1585' '#1585#1608#1586#1575#1606#1607
  ClientHeight = 404
  ClientWidth = 376
  Color = clBtnFace
  ...
  object Label5: TLabel
    ...
    Width = 115
    Height = 15
    Caption = #1601#1610#1604#1583' '#1585#1586#1585#1608' 8 '#1662#1585#1587#1606#1604#1610'  '#1576#1585#1575#1576#1585
    FocusControl = txtreserve8
  end
