...
procedure TfrmExitNoCard.SetWinF;
begin
  Caption := (Caption);
...
procedure TfrmExitNoCard.FillBarCodes;
var qry : TAdoQuery;
begin
...
procedure TfrmExitNoCard.ClearScrFields;
begin
  txtCarNumber.Text := '';
...
procedure TfrmExitNoCard.FillScrFields;
begin
...
function TfrmExitNoCard.AreValidFields : Boolean;
begin
...
function TfrmExitNoCard.h_m_Str(m : Integer) : String;
var
  s : String;
begin
  if (m div 60) > 0 then
...
procedure TfrmExitNoCard.FormCreate(Sender: TObject);
var qry : TAdoQuery;
begin
  SetWinF;
...
procedure TfrmExitNoCard.FormActivate(Sender: TObject);
begin
  ClearScrFields;
end;

procedure TfrmExitNoCard.cmbBarCodeKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfrmExitNoCard.txtCarNumberKeyPress(Sender: TObject;
  var Key: Char);
begin
{kaveh  if Key = #13 then
...
procedure TfrmExitNoCard.cmdSearchClick(Sender: TObject);
var
  qry : TAdoQuery;
  BCode : String;
begin
...
procedure TfrmExitNoCard.cmbBarCodeExit(Sender: TObject);
var ret : Integer;
begin
  if cmbBarCode.Text <> '' then
  begin
...
procedure TfrmExitNoCard.txtDateKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = 13 then
  begin
...
procedure TfrmExitNoCard.txtDateKeyPress(Sender: TObject; var Key: Char);
begin
  Keyboard_Date(Key);
end;

procedure TfrmExitNoCard.txtDateExit(Sender: TObject);
begin
...
procedure TfrmExitNoCard.txtTimeExit(Sender: TObject);
begin
...
procedure TfrmExitNoCard.txtTimeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = 13 then
  begin
...
procedure TfrmExitNoCard.txtTimeKeyPress(Sender: TObject; var Key: Char);
begin
  Keyboard_Time(Key);
end;

procedure TfrmExitNoCard.txtPriceKeyPress(Sender: TObject; var Key: Char);
begin
{kaveh  if Key = #13 then
  begin
    Key := #0;
...
procedure TfrmExitNoCard.txtPriceExit(Sender: TObject);
begin
...
procedure TfrmExitNoCard.txtTakhfifKeyPress(Sender: TObject; var Key: Char);
begin
{kaveh  if Key = #13 then
  begin
    Key := #0;
...
procedure TfrmExitNoCard.cmbDoorCodeKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure TfrmExitNoCard.cmbDoorCodeClick(Sender: TObject);
begin
  cmbDoorName.ItemIndex := cmbDoorCode.ItemIndex;
end;

procedure TfrmExitNoCard.cmbDoorNameClick(Sender: TObject);
begin
  cmbDoorCode.ItemIndex := cmbDoorName.ItemIndex;
end;


procedure TfrmExitNoCard.cmbPersonCodeKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure TfrmExitNoCard.cmbPersonCodeClick(Sender: TObject);
begin
  cmbPersonName.ItemIndex := cmbPersonCode.ItemIndex;
end;

procedure TfrmExitNoCard.cmbPersonNameClick(Sender: TObject);
begin
  cmbPersonCode.ItemIndex := cmbPersonName.ItemIndex;
end;

procedure TfrmExitNoCard.txtDescribeKeyPress(Sender: TObject;
  var Key: Char);
begin
{kaveh  if Key = #13 then
  begin
...
procedure TfrmExitNoCard.txtMadarekKeyPress(Sender: TObject;
  var Key: Char);
begin
{kaveh  if Key = #13 then
  begin
...
procedure TfrmExitNoCard.cmdSaveClick(Sender: TObject);
begin
