...
string Menu::get_appropriate_message (FixMessage index, Language l)
{
	...
	case Farsi:
		...
		case FM_EnterPassword:
			message = "ÑãÒ ÚÈæÑ ÑÇ æÇÑÏ ˜äíÏ";
			break;
			
		case FM_IncorrectPassword:
			message = "ÑãÒ ÇÔÊÈÇå ÇÓÊ";
			break;		
		...
		case FM_TimeAdjustSuceess:
			message = "ÒãÇä ÊäÙíã ÔÏ";
			break;	
			
		case FM_TimeAdjustFail:
			message = "ÇÔ˜Çá ÏÑ ÊäÙíã ÒãÇä";
			break;			
			
		case FM_DateAdjustSuceess:
			message = "ÊÇÑíÎ ÊäÙíã ÔÏ";
			break;	
			
		case FM_DateAdjustFail:
			message = "ÇÔ˜Çá ÏÑ ÊäÙíã ÊÇÑíÎ";
			break;	
			
		case FM_ChangePassword:
			message = "ÑãÒ ÌÏíÏ ÑÇ æÇÑÏ ˜äíÏ";
			break;				
		...
		case FM_PortAdjustSuccess:
			...
			message = "ãæÏã ÊäÙíã ÔÏ";
			break;         
			
		case FM_PortAdjustFail:
			message = "ÇÔ˜Çá ÏÑ ÊäÙíã troP";
			break;
                        
                case FM_ModemInitFail:                      //d.k
			message = "ÇÔ˜Çá ÏÑ ÊäÙíã ãæÏã";
			break;        
		...
		case FM_CardOrFinger:
			message = "˜ÇÑÊ íÇ ÇäÔÊ";
			break;		
			
		case FM_DeviceMode:
			message = "íÔ ÝÑÖ ÏÓÊÇå";
			break;				
		...
		case FM_TemplateCount:
                  message = "ÇáæåÇí ÇËÑ ÇäÔÊ :";
			break;	
                        
                case FM_EditFingers:
                  message = "æíÑÇíÔ ÇËÑ ÇäÔÊ :";
			break;
		...
		case FM_RepetitivePersonalNumber:
			message = "Ô  Ê˜ÑÇÑí ÇÓÊ";
			break;
			
		case FM_InvalidPersonalNumber:
			message = "Ô  ÇÔÊÈÇå ÇÓÊ";
			break;
			
		case FM_PersonAddSuccessfully:
			message = "˜ÇÑÈÑ ÐÎíÑå ÔÏ";
			break;
			
		case FM_PersonAddFail:
			message = "ÇÔ˜Çá ÏÑ ÊÚÑíÝ ˜ÇÑÈÑ";
			break;
			
		case FM_PersonEditSuccessfully:
			message = "˜ÇÑÈÑ æíÑÇíÔ ÔÏ";
			break;
			
		case FM_PersonEditFail:
			message = "ÇÔ˜Çá ÏÑ æíÑÇíÔ ˜ÇÑÈÑ";
			break;
			
		case FM_DeleteUser:
			message = "˜ÇÑÈÑ ÍÐÝ ÔæÏ ¿";
			break;			

		case FM_DeleteAllUser:
			message = "˜ÇÑÈÑÇä ÍÐÝ ÔæäÏ ¿";
			break;			
		...
		case FM_DeleteFail:
			message = "ÇÔ˜Çá ÏÑ ÍÐÝ ˜ÇÑÈÑ";
			break;			

		case FM_AllUserDeleteSuccess:
			message = " ˜ÇÑÈÑÇä ÍÐÝ ÔÏäÏ";
			break;			

		case FM_AllUserDeleteFail:
			message = "ÇÔ˜Çá ÏÑ ÍÐÝ ˜ÇÑÈÑÇä";
			break;		
		...
		case FM_DeviceModeChangeSuccess:
			message = "ãÏ ÏÓÊÇå ÊäÙíã ÔÏ";
			break;			
		
		case FM_DeviceModeChangeFail:
			message = "ÇÔ˜Çá ÏÑ ÊäÙíã ãÏ";
			break;			

		case FM_FMActivityChangeSuccess:
			message = "ã Ç ÊäÙíã ÔÏ";
			break;			

		case FM_FMActivityChangeFail:
			message = "ÇÔ˜Çá ÏÑ ÊäÙíã ã Ç";
			break;		
		...
		case FM_PreCardChangeSuccess:
			message = "íÔ ˜ÇÑÊ ÊäÙíã ÔÏ";
			break;				

		case FM_PreCardChangeFail:
			message = "ÇÔ˜Çá ÏÑ ÊäÙíã  ˜";
			break;				
		...
		case FM_ChangePasswordSuccess:
			message = "ÑãÒ ÚÈæÑ ÊäÙíã ÔÏ";
			break;					
			
		case FM_ChangePasswordFail:
			message = "ÇÔ˜Çá ÏÑ ÊäÙíã ÑãÒ";
			break;		

		case FM_CurrentID:
			message = "ÔäÇÓå ÏÓÊÇå";
			break;					
...
string Menu::get_menu_title (MenuIndex index, Language l)
{
	...
	case Farsi:
		...
		case MI_LANSetting:
			message = "ÊäÙíãÇÊ ÔÈ˜å";
			break;		
			
		case MI_PersonalSetting:
			message = "ÊäÙíãÇÊ ˜ÇÑÈÑ";
			break;	
			
		case MI_DeviceSetting:
			message = "ÊäÙíãÇÊ ÏÓÊÇå";
			break;		

		case MI_SetDateTime:
			message = "ÊäÙíã ÊÇÑíÎ æ ÒãÇä";
			break;					
		...
		case MI_SetPort:
			...
			break;
                ...
                case MI_SetIP:                          //dk
                        message = "ÊäÙíã sserdda PI";
			break;
                        
                case MI_SetServerIP:                     //dk
			message = "ÊäÙíã revres SND";
			break;
         
                case MI_SetGateway:                          //dk
			message = "ÊäÙíã yawetaG";
			break;
                        
                case MI_InitModem:                              //d.k
			message = "ÊäÙíã Çæáíå ãæÏã";
			break;

		case MI_AddPerson:
			message = "ÇÖÇÝå ˜ÑÏä ˜ÇÑÈÑ";
			break;				
		...
		case MI_DeleteAllPerson:
			message = "ÍÐÝ åãå ˜ÇÑÈÑÇä";
			break;	
			
		case MI_DeviceMode:
			message = "ÊäÙíã ãÏ ÏÓÊÇå";
			break;			

		case MI_FMActivity:
			message = "ÝÚÇáíÊ ÇËÑ ÇäÔÊ";
			break;			
		
		case MI_DevicePreCard:
			message = "ÊäÙíã íÔ ˜ÇÑÊ";
			break;			

                case MI_DeleteTraffics:
			message = "ÍÐÝ ˜áíå ÊÑÏÏåÇ";
			break;		
		}					
	}
