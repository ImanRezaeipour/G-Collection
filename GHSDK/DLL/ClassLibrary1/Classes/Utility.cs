    ...
    public class Utility
    {
        ...
        public static Boolean IsTimeString(string time)
        {
            ...
            if (Convert.ToInt32(time.Substring(3, 2)) > 59)
                return false;
            if (Convert.ToInt32(time.Substring(6, 2)) > 59)
                return false;
            return true;
        }
        ...
        public static DateTime GenerateDateTime(string Date, string Time)
        {
            ...
            r = r.AddSeconds(Convert.ToInt32(Time.Substring(6, 2)) - 1);
        ...
        public static char StrToBCD(String ST, byte from)
        {
            return  (char)((((int)ST[from])-48)*16 + ((int)ST[from+1])-48);
        }  
        public static string BCDToStr(char ch)
        {
            string a;
            a = (((int)ch / 16) + 48).ToString() + ((int)ch % 16 + 48).ToString();
            return a;
        }
