object frmRptAmarPriceGroup: TfrmRptAmarPriceGroup
  Left = 270
  Top = 248
  ...
  object qrptPeyman: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = #1711#1586#1575#1585#1588' '#1570#1605#1575#1585' '#1605#1589#1585#1601' '#1594#1584#1575#1610#1610' '#1576#1585' '#1581#1587#1576' '#1602#1610#1605#1578
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object grpPublic: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'qryFishFood.P_BarCode'
      FooterBand = bndTotal
      Master = qrptPeyman
      ReprintOnNewPage = False
      object exprGroup: TQRExpr
        Left = 8
        Top = 8
        Width = 334
        Height = 17
        ...
        WordWrap = True
        Expression = 
          'qryFishFood.P_BarCode + '#39'-'#39' + qryFishFood.P_Family + '#39'-'#39' + qryFi' +
          'shFood.P_Name'
        FontSize = 10
      end
    end
  ...
  object qryFishFood: TADOQuery
    ...
    SQL.Strings = (
        ...
        'eFee, P_BarCode, P_Family, P_Name '
      'FROM Fish, FishFood, FoodPric, Persons'
      
        'WHERE Fish_Date = FF_Date AND Fish_Type = FF_Type AND Fish_No = ' +
        'FF_FishNo'
      'AND FF_Food = FP_FoodCode'
      'AND Fish_PCode = P_BarCode'
      'GROUP BY P_BarCode, P_Family, P_Name, FP_PriceFee'
      'ORDER BY P_BarCode')
    Left = 24
    Top = 8
  end
