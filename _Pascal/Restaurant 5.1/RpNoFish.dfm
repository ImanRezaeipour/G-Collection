object frmRpNoFish: TfrmRpNoFish
  Left = 172
  Top = 147
  BiDiMode = bdLeftToRight
  Caption = #1604#1610#1587#1578' '#1662#1585#1587#1606#1604' '#1594#1584#1575' '#1606#1582#1608#1585#1583#1607
  ClientHeight = 514
  ClientWidth = 810
  Color = clBtnFace
  ...
  object qrptNoFish: TQuickRep
    ...
    BeforePrint = qrptNoFishBeforePrint
    DataSet = qryPersonNoFish
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    PrintIfEmpty = True
    ReportTitle = #1604#1610#1587#1578' '#1662#1585#1587#1606#1604' '#1594#1584#1575' '#1606#1582#1608#1585#1583#1607
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'qryPersonNoFish.P_Family + '#39' - '#39' + qryPersonNoFish.P_Name'
        FontSize = 10
      end
  ...
  object qryPersonNoFish: TADOQuery
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM Persons, Parts, JobType'
      'WHERE P_BarCode NOT IN (SELECT Fish_PCode FROM Fish)'
      'AND P_PartCode =P_CustomCode'
      'AND P_JobCode = Job_Code'
