    ...
    public partial class DashboardUser : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string userBarcode=new BWebpassUser().GetBarcodeByUserName(User.Identity.Name);
                FillYearMonthDate(DateTime.Today);
                FillComboPishCardHourly(userBarcode);
                FillComboPishCardDaily(userBarcode);
                FillRemainLeaveToEndCurrentMonth(ASPxComboBoxYear.SelectedItem.Value.ToString(),ASPxComboBoxMonth.SelectedItem.Value.ToString(),userBarcode);
            }
        ...
        protected void ASPxCallbackPanelRemainLeave_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            string userBarcode=new BWebpassUser().GetBarcodeByUserName(User.Identity.Name);
            FillRemainLeaveToEndCurrentMonth(year, month, userBarcode);
        }
