...
uses
  Funcs, DBS, MnuSet, Login, MSGs, Keyboard, FntSel, globals;
...
begin
  with atblUsers do
    ...
    begin
      ...
      txtUserPassword.Text := decodingpass(FieldByName('User_Password').AsString);
...
begin
  ...
  begin
    ...
    begin
      ...
      FieldByName('User_Password').AsString := codingpass(txtUserPassword.Text);
