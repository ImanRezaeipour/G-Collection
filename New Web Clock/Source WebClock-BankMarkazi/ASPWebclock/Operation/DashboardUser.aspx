...
<%@ Register assembly="DevExpress.Web.v11.1, Version=11.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxRoundPanel" tagprefix="dx3" %>
...
<SubMenuStyle GutterWidth="0px"></SubMenuStyle>
  ...
  <td align="left" dir="rtl">
     <%-- <dx:ASPxCallbackPanel ID="ASPxCallbackPanelRemainLeave" ClientInstanceName="CallbackPanelRemainLeave" runat="server" Width="99%" OnCallback="ASPxCallbackPanelRemainLeave_Callback">
          <PanelCollection>
              <dx:PanelContent runat="server" ID="CallbacklblRemainLeavePanel">
                  <dx:ASPxLabel ID="ASPxLabelRemainLeaveToCurrentMonth" ClientInstanceName="LabelRemainLeaveToCurrentMonth" runat="server" Text="" Font-Names="tahoma" Font-Bold="True" Font-Size="8pt"></dx:ASPxLabel>
              </dx:PanelContent>
          </PanelCollection>
          <ClientSideEvents EndCallback="function(s,e){CallbackPanelRemainLeave_EndCallback(s,e);}" />
          <ClientSideEvents CallbackError="function(s,e){CallbackPanelRemainLeave_ErrorCallback(s,e);}" />
      </dx:ASPxCallbackPanel>--%>
     
      <dx:ASPxButton ID="ASPxButtonShowRemainLeave" ClientInstanceName="ButtonShowRemainLeave" runat="server" Text="مانده مرخصی" CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css" AutoPostBack="False">
          <ClientSideEvents Click="ButtonShowRemainLeave_onClick" />
      </dx:ASPxButton>
  </td>
  </tr>
  </table>
