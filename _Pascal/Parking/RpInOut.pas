...
procedure TfrmRptInOut.SetWinF;
begin
  Caption := (Caption);
...
procedure TfrmRptInOut.FormCreate(Sender: TObject);
begin
  SetWinF;
...
procedure TfrmRptInOut.qryMachinesCalcFields(DataSet: TDataSet);
begin
  with DataSet do
  begin
