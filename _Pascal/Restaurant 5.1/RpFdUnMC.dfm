object frmRptUnitFoodMC: TfrmRptUnitFoodMC
  Left = -4
  Top = -4
  BiDiMode = bdLeftToRight
  Caption = #1711#1586#1575#1585#1588' '#1603#1604#1610' '#1578#1593#1583#1575#1583#1610' '#1605#1575#1607#1575#1606#1607' '#1605#1608#1575#1583' '#1594#1584#1575#1610#1610' '#1608#1575#1581#1583#1607#1575#1610' '#1578#1575#1576#1593#1607
  ClientHeight = 712
  ClientWidth = 1024
  Color = clBtnFace
  ...
  object qrptUnitFood: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = #1711#1586#1575#1585#1588' '#1603#1604#1610' '#1578#1593#1583#1575#1583#1610' '#1605#1575#1607#1575#1606#1607' '#1605#1608#1575#1583' '#1594#1584#1575#1610#1610' '#1608#1575#1581#1583#1607#1575#1610' '#1578#1575#1576#1593#1607
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object bndFooterUnit: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qryUnitFood.FF_No)'
        FontSize = 10
      end
    end
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel18: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = #1603#1604' '#1607#1586#1610#1606#1607' '#1662#1585#1583#1575#1582#1578' '#1588#1583#1607
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
      ...
      object QRLabel20: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = #1603#1604' '#1607#1586#1610#1606#1607' '#1662#1585#1583#1575#1582#1578' '#1606#1588#1583#1607
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
      ...
      object QRLabel2: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = #1578#1593#1583#1575#1583' '#1605#1589#1585#1601#1610
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
