...
namespace ASPWebclock.Operation
{
    public partial class DefineInsteadMan : System.Web.UI.Page
    {
        ...
        {
            IList<WebpassUserProxy> webpassUserProxyList = userBussines.GetPostManagersOfPerson(userBussines.GetBarcodeByUserName(User.Identity.Name));
        ...
        protected void ASPxCallbackUpdateInsteadMan_Callback(object source, DevExpress.Web.ASPxCallback.CallbackEventArgs e)
        {
            ...
            try
            {
                ...
                if (postsID == "All")
                {
                    IList<WebpassUserProxy> webpassProxyList = userBussines.GetPostManagersOfPerson(userBussines.GetBarcodeByUserName(User.Identity.Name));
