    ...
    public partial class RemainLeaveViewer : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Convert.ToBoolean(ConfigurationManager.AppSettings["UseCCService"]) == true)
            {
                ...
                bool result = ccService.CalculateOnePerson(personObj.Barcode, year, month, encryptionCode);
            }
            else
            {
                ...
                startInfo.Arguments = personObj.Barcode + " " + year + " " + month;
            ...
            stiReport["@barcode"] = personObj.Barcode;
            Response.Clear();
