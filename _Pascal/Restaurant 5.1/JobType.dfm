object frmJobType: TfrmJobType
  ...
  Caption = #1578#1593#1585#1610#1601' '#1575#1606#1608#1575#1593' '#1575#1587#1578#1582#1583#1575#1605
  ClientHeight = 265
  ClientWidth = 464
  Color = clBtnFace
  ...
  object grpEdit: TGroupBox
    ...
    object lbl1: TLabel
      ...
      Width = 44
      Height = 15
      Caption = '&'#1603#1583' '#1575#1587#1578#1582#1583#1575#1605
  ...
  object tblJob: TADOTable
    ...
    Left = 248
    Top = 72
    object tblJobJob_Code: TSmallintField
      Alignment = taCenter
      DisplayLabel = #1603#1583' '#1575#1587#1578#1582#1583#1575#1605
      DisplayWidth = 8
      FieldName = 'Job_Code'
    end
    object tblJobJob_Name: TStringField
      DisplayLabel = '                         '#1606#1608#1593' '#1575#1587#1578#1582#1583#1575#1605
      DisplayWidth = 35
      FieldName = 'Job_Name'
      Size = 15
    end
