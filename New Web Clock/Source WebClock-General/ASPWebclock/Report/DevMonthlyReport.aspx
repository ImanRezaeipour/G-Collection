...
grid.CancelEdit();
           ...
           <ClientSideEvents EndCallback="function(s,e){GridViewReportMonthly_EndCallback(s,e);}" />
        </dx:ASPxGridView>
        
        </dx:PanelContent>
        </PanelCollection>
        <ClientSideEvents EndCallback="function(s,e){CallbackPanelGridReportMonthly_EndCallback(s,e);}" />
        </dx:ASPxCallbackPanel>
