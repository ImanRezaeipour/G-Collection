...
const
  ...
  RDR_CLOCKZ80  = 3;
  RDR_PROXI     = 4;
  ReadersName  : array[RDR_RESTZ84..RDR_PROXI] of String =
                 ('—” Ê—«‰Ì Z84', '—” Ê—«‰Ì Z80', '”«⁄  Z84', '”«⁄  Z80', 'Proximity');
  ...
  MB_NAHAR      = 2;
  MB_SHAM       = 3;
  FoodName : array[MB_SOBH..MB_SHAM] of string = ('’»Õ«‰Â', '‰«Â«—', '‘«„');
...
type TParams = record
  ...
  Vadeh        : array[MB_SOBH..MB_SHAM] of Byte;
  FromSobh     : String[5];
  ToSobh       : String[5];
  SobhKeyNo    : Byte;
...
var
  g_Options     : TOptions;
  F_Params      : TParams;
  DayGroup      : array [1..100] of TGroup;
  Readers       : array[1..100] of TReaders;
  DayFoodList   : array[MB_SOBH..MB_SHAM] of TDayProg;
  FoodsList     : array[1..500] of TFoodList;
  UsedFoods     : array[MB_SOBH..MB_SHAM,1..8] of Integer;
  TotalFoods,
  TotalActvRdr,
  TotalOnLineRdr,
  TotalReader   : Byte;
