object frmRptAmarTabkhFP1: TfrmRptAmarTabkhFP1
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qrptAmarTabkhFP1: TQuickRep
    Left = 8
    Top = 8
    Width = 794
    Height = 1123
    ...
    BeforePrint = qrptAmarTabkhFP1BeforePrint
    DataSet = qryAmarTabkhFP1
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    PrintIfEmpty = False
    ReportTitle = #1711#1586#1575#1585#1588' '#1602#1610#1605#1578' '#1594#1584#1575#1607#1575
    SnapToGrid = True
    Units = MM
    Zoom = 100
  ...
  object qryAmarTabkhFP1: TADOQuery
    ConnectionString = 
      'Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security In' +
      'fo=False;Initial Catalog=rest;Data Source=.'
    CursorType = ctStatic
    OnCalcFields = qryAmarTabkhFP1CalcFields
    Parameters = <>
    SQL.Strings = (
      'select * from amartabkhf')
    Left = 128
    object qryAmarTabkhFP1Date: TWideStringField
      FieldName = 'Date'
      Size = 10
    end
    object qryAmarTabkhFP1Day: TWideStringField
      FieldName = 'Day'
      Size = 10
    end
    object qryAmarTabkhFP1Vadeh: TSmallintField
      FieldName = 'Vadeh'
    end
    object qryAmarTabkhFP1food: TWideStringField
      FieldName = 'food'
      Size = 30
    end
    object qryAmarTabkhFP1personno: TWideStringField
      FieldName = 'personno'
      Size = 8
    end
    object qryAmarTabkhFP1cnt: TSmallintField
      FieldName = 'cnt'
    end
    object qryAmarTabkhFP1Building: TWideStringField
      FieldName = 'Building'
      Size = 30
    end
    object qryAmarTabkhFP1p_family: TStringField
      FieldName = 'p_family'
      Size = 30
    end
    object qryAmarTabkhFP1p_name: TStringField
      FieldName = 'p_name'
    end
    object qryAmarTabkhFP1prc: TCurrencyField
      FieldName = 'prc'
    end
  end
end
