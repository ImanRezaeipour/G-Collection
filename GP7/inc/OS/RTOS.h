...
in order to be able to automatically remap the identifiers.
...
#define OS_VERSION_GENERIC (38007)       /*   Generic version 3.80g */
...
#define OS_TimeDex       OS_Global.TimeDex
  ...
  */
    ...
    OS_EXTERN OS_SADDR  OS_GLOBAL  OS_Global;                /* Major OS variables, initialized in OSGlobal.c */
    ...
    OS_EXTERN OS_GLOBAL OS_SADDR OS_Global;                  /* Major OS variables, initialized in OSGlobal.c */
  ...
  OS_EXTERN OS_PENDING OS_SADDR OS_Pending;
...
/*
unsigned OS_INTPRIO_Get(void);
void     OS_INTPRIO_Set(unsigned v);
#define  OS_INTPRIO_GET(v) { v = OS_INTPRIO_Get(); }
#define  OS_INTPRIO_SET(v) { OS_INTPRIO_Set(v);    }
*/
...
#endif /* End of ARM specific part */
