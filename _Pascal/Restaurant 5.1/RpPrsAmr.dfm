object frmRptPrsAmar: TfrmRptPrsAmar
  Left = 141
  Top = 149
  ...
  object qrptPrsFish: TQuickRep
    ...
    object grpBarCode: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'qryPrsFish.P_BarCode'
    ...
    object ChildBand2: TQRChildBand
      ...
      object lblnaharname: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = 'lblnaharname'
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
      end
      object lblshamname: TQRLabel
        Left = 9
        Top = 8
        Width = 217
        Height = 17
  ...
  object qryPrsFish: TADOQuery
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM Fish, Persons WHERE Fish_PCode = P_BarCode'
      'AND P_BarCode = '#39'00001001'#39
      'ORDER BY P_BarCode')
    Left = 25
    Top = 8
  end
